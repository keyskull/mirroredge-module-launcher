...
std::string Dolly::GetId() const { return "dolly"; }

std::string Dolly::GetName() const { return "Dolly"; }

std::string Dolly::GetDescription() const {
    return "Dolly camera for cinematics and player recording playback.";
}